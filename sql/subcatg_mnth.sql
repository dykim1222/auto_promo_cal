...
CREATE TABLE USER_WORKING.daeyoung_promo_subcatg_mnth AS (
WITH a AS (
...
update USER_WORKING.daeyoung_promo_subcatg_mnth set subcatg_name = oreplace(subcatg_name,',', ' ') where subcatg_name like '%,%'
